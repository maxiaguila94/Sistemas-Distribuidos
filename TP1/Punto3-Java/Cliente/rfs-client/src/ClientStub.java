...
public class ClientStub {
	...
	public void rfs_open(String file_name) throws ClassNotFoundException {
	...
	public void rfs_read(File archivo_remoto_abierto, byte[] buffer) throws IOException, ClassNotFoundException {
